...
var SettingService = _interopRequireWildcard(require("./setting.service"));
...
var router = (0, _express.Router)(); // App Settings

router.get("/app", SettingService.getAppSettings);
router.post("/app", SettingService.setAppSettings);
router.put("/app", SettingService.updateAppSettings); // Any setting
